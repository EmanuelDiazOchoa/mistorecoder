...
function IconHome({ color, size = 24 }: IconProps) {
  return (
...
function IconBag({ color, size = 24 }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function IconReceipt({ color, size = 24 }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function IconUser({ color, size = 24 }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
  ...
  return (
    <Pressable onPress={onPress} style={styles.tabBtn}>
      <Animated.View style={[styles.iconWrap, { transform: [{ scale }] }]}>
        <Animated.View style={[styles.activePill, { width: pillWidth, opacity: pillOpacity, backgroundColor: accentColor }]} />
      ...
      <Animated.Text style={[styles.tabLabel, { color, opacity: labelO }]}>{label}</Animated.Text>
    </Pressable>
  );
}
