...
interface HeartIconProps { filled: boolean; }

function IconChevronLeft({ color = '#FFFFFF', size = 20 }: SvgIconProps) {
  return (
...
function IconCart({ color = '#fff', size = 20 }: SvgIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function IconVerified({ color, size = 18 }: SvgIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function IconShipping({ color, size = 18 }: SvgIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function IconStar({ color, size = 18 }: SvgIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" stroke={color} strokeWidth={1.8} strokeLinejoin="round" fill="none" />
    </Svg>
...
const styles = StyleSheet.create({
  ...
  ratingBadge: { backgroundColor: 'rgba(245,158,11,0.15)', borderWidth: 1, borderColor: 'rgba(245,158,11,0.3)', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 5 },
